<div class="h-screen border-none overflow-auto" style="background-color:#033c59;">
    ...
    <div class="mt-10">
        ...
        <div class="bg-white">
            <div class="bg-a h-10 rounded-br-3xl" style="border:1px solid #033c59;"></div>
            <button onclick="window.location.href='/profile'" class="w-100 p-3 text-lg bg-white text-black"><i class="fa-solid fa-user"></i> Account Info</button>
            <button onclick="window.location.href='/personal'" class="bg-a rounded-tr-3xl w-100 p-3 text-slate-300 text-lg hover:text-slate-400" style="border:1px solid #033c59;"><i class="fa-sharp fa-solid fa-file-invoice"></i> Personal Info</button>
            <button onclick="window.location.href='/modules'" class="bg-a w-100 p-3 text-slate-300 text-lg hover:text-slate-400"><i class="fa-solid fa-book"></i> My Modules</button>
            <button onclick="window.location.href='/notes'" class="bg-a  w-100 p-3 text-slate-300 text-lg hover:text-slate-400"><i class="fa-sharp fa-solid fa-clipboard"></i> My Notes</button>
        

            <form class="bg-a flex justify-center pt-20 mb-10" method="POST" action="/logout">
                @csrf
