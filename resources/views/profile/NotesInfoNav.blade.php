<div class="h-screen border-none overflow-auto" style="background-color:#033c59;">
    ...
    <div class="mt-10">
        ...
        <div class="bg-white">
            ...
            <button onclick="window.location.href='/personal'" class="w-100 bg-a  p-3 text-slate-300 text-lg hover:text-slate-400"><i class="fa-sharp fa-solid fa-file-invoice"></i> Personal Info</button>
            <button onclick="window.location.href='/modules'" class="rounded-br-3xl bg-a w-100  p-3 text-slate-300 text-lg hover:text-slate-400" style="border:1px solid #033c59;"><i class="fa-solid fa-book"></i> My Modules</button>
            <button onclick="window.location.href='/notes'" class="w-100 p-3 text-black text-lg"><i class="fa-sharp fa-solid fa-clipboard"></i> My Notes</button>
        

            <form class="flex justify-center pt-20 mb-10 bg-a rounded-tr-3xl" style="border:1px solid #033c59;" method="POST" action="/logout">
                @csrf
