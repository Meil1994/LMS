<div class="h-screen border-none overflow-auto" style="background-color:#033c59;">
    ...
    <div class="mt-10">
        ...
        <div class="bg-white">
            ...
            <button onclick="window.location.href='/profile'" class="w-100 bg-a rounded-br-3xl p-3 text-slate-300 text-lg hover:text-slate-400" style="border:1px solid #033c59;"><i class="fa-solid fa-user"></i> Account Info</button>
            <button onclick="window.location.href='/personal'" class="w-100 p-3 text-lg bg-white text-black"><i class="fa-sharp fa-solid fa-file-invoice"></i> Personal Info</button>
            <button onclick="window.location.href='/modules'" class="bg-a rounded-tr-3xl w-100 p-3 text-slate-300 text-lg hover:text-slate-400" style="border:1px solid #033c59;"><i class="fa-solid fa-book"></i> My Modules</button>
