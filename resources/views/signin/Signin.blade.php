                  ...
                  <h3 class="text-white">Mag Sign In</h3>
                      ...
                      <form method="POST" action="/user/authenticate">
                        ...
                        <div class="form-group first">
                          <label for="username" class="text-white text-lg float-left mb-1"><i class="fa fa-duotone fa-user"></i>&nbsp;&nbsp; Username</label>
                          <input 
                          type="text" 
                      ...
                      <div class="flex justify-center pt-3">
                        <button type="button" onclick="window.location.href='/emailsignin'" class="text-13 text-white no-underline p-1 rounded-md">Login using Email</button>
                      </div>
              </div>
            </div>         
            </div>
